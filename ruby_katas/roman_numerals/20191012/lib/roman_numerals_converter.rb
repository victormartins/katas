...
class RomanNumeralsConverter
  ...
  def initialize(arabic_to_roman_klass = ArabicToRoman, roman_to_arabic_klass = RomanToArabic)
    @arabic_to_roman = arabic_to_roman_klass.new(ROMAN_NUMERALS)
    @roman_to_arabic = roman_to_arabic_klass.new(ROMAN_NUMERALS)
  end
