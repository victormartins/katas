class RomanConverter {
  ...
  static convert(value) {
    const arabic_to_roman = new ArabicToRoman(this.ROMAN_NUMERALS);
    const roman_to_arabic = new RomanToArabic(this.ROMAN_NUMERALS);

    if(typeof(value) === 'string') return roman_to_arabic.call(value)
    return arabic_to_roman.call(value)
  }
}
